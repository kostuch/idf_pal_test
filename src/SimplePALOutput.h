...
const int lineSamples = 854; // 854*75ns=64.050us
const int memSamples = 856;
const int imageSamples = 640;
const int syncLevel = 0;
const int blankLevel = 23;
// Im wieksze frameStart, tym bardziej obraz przesuniety w prawo
const int frameStart = 170; //must be even to simplify buffer word swap (160)

// 75ns - jeden okres dla zegara 13.333333 MHz
// Oryginalnie syncSamples=64 (ale wtedy obraz za bardzo w lewo)
const int syncSamples = 64; //4.8us
const int burstSamples = 38; //2.85us
const int burstStart = 70; //5.25us
const int burstAmp = 12;
const int maxLevel = 34; //34
const float burstPerSample = (2 * M_PI) / (13333333 / 4433618.75);// 2.088234483455862
const float colorFactor = (M_PI * 2) / 16;//0.3925
const float burstPhase = M_PI / 4 * 3;//2.355
