...
void SimplePALOutput::sendLine(unsigned short *l)
{
...
void SimplePALOutput::sendFrame(char ***frame)
{
	// Bez przeplotu
	...
	for (int i = 0; i < 25; i++) sendLine(blank);								// blank lines

	for (int i = 0; i < 3; i++)	sendLine(shortSync);							// short sync
}